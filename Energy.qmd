...
author: "Alejandro Barajas, Gary Layman, Trevor Olmo, Add your names here"
date: today
format: pdf
editor: source
---
...
Here I just check number of rows and columns, as well as the data types of the columns.
...
```{python}
# YOUR CODE HERE
# limits to just where cost is NA and finds all the unique fuelTypeDescriptions
energy_df[energy_df["cost"].isna()]["fuelTypeDescription"].unique()
```
